...
var Ace = _interopRequire(require("./ace"));
...
var Editor = _interopRequire(require("../editor/editor"));
  ...
  _createClass(View, {
    render: {
      value: function render() {
        ...
        }), React.createElement("div", { className: "editor-and-runner" }, React.createElement("div", { id: this.props.editorId, className: "editor" }), React.createElement("div", { id: this.props.runnerId, className: "runner" })), React.createElement(KeyboardShortcutOverlay, {
          metaKeySymbol: props.metaKeySymbol,
